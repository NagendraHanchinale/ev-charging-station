...
//   try {
//     console.log('Forwarding bill to BPP at http://localhost:4001/payment/bill');
//     const response = await axios.post('http://localhost:4001/payment/bill', billData);
...
//   try {
//     // Forward to BPP
//     console.log('Forwarding confirmBill to BPP at http://localhost:4001/payment/confirmBill');
//     const response = await axios.post('http://localhost:4001/payment/confirmBill', confirmData);
//     console.log('Response from BPP:', response.data);
...
// BPP base URL
const BPP_BASE_URL = 'http://localhost:4001';
...
router.post('/initiate-payment', async (req, res) => {
  try {
    ...
    console.error('Error initiating payments:', error.message);
