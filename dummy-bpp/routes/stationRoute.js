...
// 📥 Get all stations
// Fetch stations from both external API and MongoDB

router.get('/combinedStations', async (req, res) => {
    try {
        ...
        // Combine the results (you can customize this logic)
        const combinedStations = {
            mongoStations: mongoStations,
            externalStations: result.data
        };
